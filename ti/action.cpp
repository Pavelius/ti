...
{"IntoTheBreach", "Прорыв", 1, AsAction, ""},
...
{"StrategicBombardment", "Стратегическая бомбардировка", 1, AsAction, ""},
{"StrategicFlexibility", "", 1, AsAction, ""},
{"StrategicShift", "", 1, AsAction, ""},
{"SuccessfulSpy", "Удачный шпионаж", 1, AsAction, ""},
