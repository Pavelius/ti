...
#define endofs(e) (e + sizeof(e)/sizeof(e[0]) - 1)
...
inline char*						szprints(char* result, const char* result_max, const char* format, ...) { return szprintvs(result, result_max, format, xva_start(format)); }
